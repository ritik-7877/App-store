...
class AppStore extends Component {
  ...
  getFiltredApps = searchResults => {
    const {activeTab} = this.state
    const filteredApps = searchResults.filter(
      eachAppDetails => eachAppDetails.category === activeTab,
    )
    return filteredApps
  }
  ...
  render() {
    ...
    const filteredApps = this.getFiltredApps(searchResults)

    return (
      <div className="app-store-background">
        <div className="app-store-card">
          <h1 className="app-store"> App Store </h1>
